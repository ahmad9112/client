      ...
      <section className="relative bg-black text-white overflow-hidden min-h-[450px]">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4 pt-28 md:pt-36 max-w-4xl mx-auto">
          ...
          <h1 className="text-2xl md:text-4xl font-bold leading-snug mb-4">
            Unlock Intelligent Customer <br /> Success™ with Dexy AI
          </h1>
          <p className="text-lg md:text text-gray-300 mb-6">
            Stay ahead of customer needs with DexKor’s AI-native intelligence
            layer. Dexy AI helps your teams detect churn risks, generate
            insights, and automate repetitive tasks — giving you proactive
            control over Success, Support, and RevOps in one place.
          </p>
          ...
          <a
            ...
            className="bg-white text-black font-semibold px-8 py-4 rounded-full hover:bg-gray-100 transition inline-block"
          >
            Get started
          </a>
        </div>
      ...
      <section className="bg-black py-16 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="rounded-xl shadow-md p-6 text-center">
            ...
            <h3 className="text-lg font-semibold">Misclassification Risks</h3>
          </div>
